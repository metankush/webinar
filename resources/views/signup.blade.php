            ...
            <div class="row height-100 align-items-center">
                <div class="col-md-5">
                    <div class="login-form-box">
                        <h1 class="fw-normal mb-3 pb-3 text-white weight-700" style="letter-spacing: 1px;">Sign Up<br> your account</h1>
                        <form id="sitelogin" name="login-form" action="{{route('signup-process')}}" method="POST">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input name="name" type="text" id="form2Example11" class="form-control form-control-lg bg-white">
                            ...
                            <div class="form-outline input-group mb-1 login-password-field">
                                ...
                                <input name="password" type="password" id="form2Example26" class="form-control form-control-lg bg-white">
                            ...
                            <div class="form-outline input-group mb-1 login-password-field">
                                ...
                                <input name="cpassword" type="password" id="form2Example27" class="form-control form-control-lg bg-white">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="login-password-show"><i class="fa fa-eye-slash" aria-hidden="true"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 mb-4">
                                <button id="signupbtn" class="btn btn-primary btn-lg btn-block btn-blue" type="submit">Sign Up</button>
                            </div>
                            <p class="mb-5 pb-lg-2" style="color: #FFFF;">Already have an Customer account ? <a href="{{route('login-form')}}" class="text-blue">Sign In!</a></p>
                        </form>
                    </div>
                </div>
